...
'mod/ereflect:addinstance' => array(    'riskbitmask' => RISK_SPAM | RISK_XSS,
    ...
    // Only studens should be allow to submit questionnaires
    'mod/ereflect:submit' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW
    ...
    'mod/ereflect:addinstance' => array(
